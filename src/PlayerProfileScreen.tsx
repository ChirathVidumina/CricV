...
export default function PlayerProfileScreen({
    ...
    // Load saved profile data from AsyncStorage into form state on mount
    useEffect(() => {
            ...
            <View style={styles.header}>
                <View style={styles.headerTitleRow}>
                    {(onBack || navigation?.goBack) && (
                        <TouchableOpacity onPress={handleBackAction} style={{ paddingVertical: 4, paddingRight: 10 }}>
                ...
                <Text style={styles.headerSubtitle}>Configure your CricV player identity</Text>
            </View>
